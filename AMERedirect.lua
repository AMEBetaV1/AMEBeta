...
local UILibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/AMEBeta/AMEBeta-v.1/refs/heads/main/AMEBetaUI.lua"))();
 ...
 local GetConfig = function()
     local read, data = pcall(readfile, "AMEBeta.json");
 ...
 local MainUI = UILibrary.new(Color3.fromRGB(0, 255, 0));
 local Window = MainUI:LoadWindow('<font color="#90EE90">AMEBeta</font> Lua', UDim2.fromOffset(400, 279));
 
 -- Initialize the UI with the purple theme
 local MainUI = UILibrary.new(Color3.fromRGB(0, 255, 0)); -- Hex #4307f1
 local Window = MainUI:LoadWindow('<font color="#90EE90">AMEBeta</font> Lua', UDim2.fromOffset(400, 279));
